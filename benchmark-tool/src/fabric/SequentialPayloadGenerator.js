...
class SequentialPayloadGenerator extends PayloadGeneratorInterface {
    ...
    generate(counter) {
        ...
        for (var i = 0; i < counter; i++)
        {
            ...
            for (var j = 1; j < this.args[0].args.length; j++)
            {
                ...
                var payloadData = this.args[0].args[j][payloadDataKey] + i;
                var payload = {}
                payload[payloadDataKey + i] = payloadData
...
module.exports = SequentialPayloadGenerator;

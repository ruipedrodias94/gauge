...
var caliper_util = require('./util.js');
...
function getResultConfirmation(resultsArray, no_Of_Tx) {
	...
	return new Promise(function (resolve, reject) {
		...
		consumer.on('message', function (message) {
			...
			console.log("from q", JSON.parse(data))
...
function invokebycontext(context, id, version, args, timeout, channelId) {
	...
	channelConfig = caliper_util.getChannel(channelId);
...
function querybycontext(context, id, version, args, channelId) {
	var channel, channelConfig
	var configPath = "../../benchmark/ChannelScalability/fabric.json"

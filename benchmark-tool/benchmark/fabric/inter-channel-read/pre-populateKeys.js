...
var channelName = Client.getConfigSetting('fabric').channel[1].name;
	...
	logger.info("height: = ",height)
		...
		if(cmd == "-a"){
			...
			if(count <= granularity){
				return invokebycontext(chaincodes[1].id, chaincodes[1].version, ["0",count.toString()], "addaccounts","org1");
				...
				return new Promise(function(resolve,reject){
						...
						eh.registerBlockEvent((block) => {
							...
							if(c>0){
								...
								invokebycontext(chaincodes[1].id, chaincodes[1].version, [temp.toString(),(temp+granularity).toString()], "addaccounts","org1").then(()=>{
						...
						if(c>0){
								...
								invokebycontext(chaincodes[1].id, chaincodes[1].version, [z.toString(),(z+granularity).toString()], "addaccounts","org1").then(()=>{

...
*
* @file Implementation of the user test module for Chaincode scalability read-only workload
*/
...
module.exports.run = function(iteration) {
    ...
    return bc.queryState(contx, config_arguments[iteration-1]["chaincodeid"], 'v0', config_arguments[iteration-1]["args"]);
}
